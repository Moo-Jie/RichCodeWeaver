...
public class RabbitMQConfig {
    ...
    public static final String BUILD_VUE_PROJECT_QUEUE = "build.vue.project.queue";
    public static final String GENERATE_SCREENSHOT_QUEUE = "generate.screenshot.queue";
    public static final String UPLOAD_FILE_QUEUE = "upload.file.queue";
    public static final String DLX_QUEUE = "dlx.queue";
    
    // 交换机名称常量
    
    public static final String BUILD_EXCHANGE = "build.exchange";
    ...
    public static final String BUILD_VUE_PROJECT_ROUTING_KEY = "build.vue.project";
    public static final String GENERATE_SCREENSHOT_ROUTING_KEY = "generate.screenshot";
    ...
    /**
     * Vue项目构建队列
     * 配置消息TTL为10分钟，超时进入死信队列
     */
    @Bean
    public Queue buildVueProjectQueue() {
        return QueueBuilder.durable(BUILD_VUE_PROJECT_QUEUE)
     ...
     */
    @Bean
    public Binding buildVueProjectBinding() {
        return BindingBuilder.bind(buildVueProjectQueue())
                .to(buildExchange())
                .with(BUILD_VUE_PROJECT_ROUTING_KEY);
    }
     ...
     */
    @Bean
    public Queue generateScreenshotQueue() {
        return QueueBuilder.durable(GENERATE_SCREENSHOT_QUEUE)
    ...
    public DirectExchange screenshotExchange() {
        return new DirectExchange(SCREENSHOT_EXCHANGE, true, false);
    }
     ...
     */
    @Bean
    public Binding generateScreenshotBinding() {
        return BindingBuilder.bind(generateScreenshotQueue())
                .to(screenshotExchange())
                .with(GENERATE_SCREENSHOT_ROUTING_KEY);
    }
