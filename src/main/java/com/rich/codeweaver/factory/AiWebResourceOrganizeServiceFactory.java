...
import com.rich.codeweaver.aiTools.webOperate.AiWebScrapingTool;
import com.rich.codeweaver.aiTools.webOperate.AiWebSearchTool;
import com.rich.codeweaver.common.exception.BusinessException;
import com.rich.codeweaver.common.exception.ErrorCode;
import com.rich.codeweaver.service.generator.AiWebResourceOrganizeService;
...
public class AiWebResourceOrganizeServiceFactory {
    ...
    public AiWebResourceOrganizeService createAiWebResourceOrganizeService() {
        String systemPromptContent = systemPromptService.getPromptContentByKey("web-resource-organize-system-prompt");
