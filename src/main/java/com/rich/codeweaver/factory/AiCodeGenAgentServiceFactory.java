...
import com.rich.codeweaver.agent.AiCodeGenAgentService;
...
public class AiCodeGenAgentServiceFactory {
    ...
    private String loadAgentSystemPrompt() {
        String systemPrompt = systemPromptService.getPromptContentByKey(AiServiceConstant.AGENT_SYSTEM_PROMPT_KEY);
