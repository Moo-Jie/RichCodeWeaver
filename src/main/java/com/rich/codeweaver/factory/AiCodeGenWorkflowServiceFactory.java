...
import com.rich.codeweaver.common.constant.AiServiceConstant;
...
public class AiCodeGenWorkflowServiceFactory {
     ...
     *
     * @param appId 产物 id
     * @return com.rich.codeweaver.service.aiChatService.AiCodeGeneratorService
     * @author DuRuiChi
     * @create 2025/12/18
     **/
    ...
    private String loadSystemPromptContent(CodeGeneratorTypeEnum codeGenTypeEnum) {
        ...
        String systemPromptContent = systemPromptService.getPromptContentByKey(promptKey);
