...
import com.rich.codeweaver.model.dto.material.MaterialAddRequest;
import com.rich.codeweaver.model.dto.material.MaterialQueryRequest;
import com.rich.codeweaver.model.dto.material.MaterialUpdateRequest;
...
public class MaterialController {
    ...
    public BaseResponse<Boolean> updateMaterial(@RequestBody MaterialUpdateRequest updateRequest,
        ...
        if (!oldMaterial.getUserId().equals(loginUser.getId()) && !userService.isAdmin(loginUser)) {
    ...
    public BaseResponse<Boolean> deleteMaterial(@RequestBody DeleteRequest deleteRequest,
        ...
        if (!material.getUserId().equals(loginUser.getId()) && !userService.isAdmin(loginUser)) {
