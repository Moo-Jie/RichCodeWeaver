...
import com.rich.codeweaver.service.customer.AiCustomerService;
import com.rich.codeweaver.service.customer.CustomerServiceConversationService;
import com.rich.codeweaver.service.customer.CustomerServiceMessageService;
import com.rich.codeweaver.service.customer.CustomerServiceService;
import com.rich.codeweaver.service.user.StreamSessionService;
import com.rich.codeweaver.utils.ConvertTokenStreamToFluxUtils.ConvertCustomerServiceTokenStreamToFluxUtils;
...
public class CustomerServiceServiceImpl implements CustomerServiceService {
    ...
    private VisitorContext getVisitorContext(HttpServletRequest request) {
        ...
        Long userId = SessionUserUtils.resolveUserId(loginUser);
        if (userId != null) {
            return new VisitorContext(userId, null, CustomerServiceConstant.USER_IDENTITY_PREFIX + userId, userId);
        }
